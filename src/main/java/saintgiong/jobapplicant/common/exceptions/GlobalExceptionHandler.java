...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ExceptionResponse> handleBaseException(BaseException ex) {
    LoggingUtils.logError(
        GlobalExceptionHandler.class, "BaseException occurred: " + ex.getMessage(), ex);
  ...
  public ResponseEntity<ExceptionResponse> handleNoResourceFoundException(
    ...
    LoggingUtils.logError(
        GlobalExceptionHandler.class, "No resource found: " + ex.getMessage(), ex);
    ExceptionResponse response =
        ExceptionResponse.builder()
  ...
  public ResponseEntity<ExceptionResponse> handleException(Exception ex) {
    LoggingUtils.logError(
        GlobalExceptionHandler.class, "Exception occurred: " + ex.getMessage(), ex);
