...
public class ExceptionHandlerRegistry {
  ...
  private final Map<Class<? extends Throwable>, Function<Throwable, ExceptionResponse>> handlers =
      new ConcurrentHashMap<>();

  public <T extends Throwable> void registerHandler(
      Class<T> exceptionClass, Function<T, ExceptionResponse> handler) {
  ...
  public Function<Throwable, ExceptionResponse> getHandler(
